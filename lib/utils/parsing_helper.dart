...
// import 'package:sanatan_sarthi_app/models/localization/localized_text.dart';

import 'my_print.dart';

class ParsingHelper {
  // static LocalizedText parseLocalizedField(dynamic field, String defaultValue) {
  //   if (field is Map<String, dynamic>) {
  //     return LocalizedText.fromMap(field);
  //   } else if (field is String) {
  //     return LocalizedText(en: field, guj: field, hi: field);
  //   }
  //   return LocalizedText(en: defaultValue, guj: defaultValue, hi: defaultValue);
  // }
  ...
  static List<T2> parseListMethod<T1, T2>(
    dynamic value, {
    List<T2>? defaultValue,
  }) {
    defaultValue ??= <T2>[];
  ...
  static Map<K2, V2> parseMapMethod<K1, V1, K2, V2>(
    dynamic value, {
  ...
  static List<Map<K, V>> parseMapsListMethod<K, V>(
    ...
    for (dynamic value in list) {
      Map<K, V> map = ParsingHelper.parseMapMethod<dynamic, dynamic, K, V>(
        value,
      );
  ...
  static String? parseStringNullableMethod(
    dynamic value, {
    String? defaultValue,
  }) {
    return value?.toString() ?? defaultValue;
  ...
  static double? parseDoubleNullableMethod(
    dynamic value, {
    double? defaultValue,
  }) {
    if (value == null) {
